...
const conditionData = {
  ...
  "knee-osteoarthritis": {
    ...
    symptoms: ["Radiating pain from lower back to legs", "Numbness in legs", "Numbness in hands & fingers", "Vertigo/dizziness"],
    causes: ["Degenerated disc problem", "AI based posture assessment -> which gives u exercise accordingly"],
